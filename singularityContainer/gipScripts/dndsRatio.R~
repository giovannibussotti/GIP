...
parser$add_argument("--nonSynNames" , nargs="+" , help="snpEff effects counting as synonimous substitutions. The default is NON_SYNONYMOUS_CODING NON_SYNONYMOUS_START START_LOST STOP_GAINED STOP_LOST [default %(default)s]" , default="NA")
