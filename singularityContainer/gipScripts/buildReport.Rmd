...
The filtered output is available from [here](`r paste0("../samples/",sample,"/",sample,"_dellyFiltered/output.tsv.gz")`).  
...
* `r length(bndDf[,1])` break end translocations (links) [BND](`r paste0("../samples/",sample,"/",sample,"_dellyFiltered/BND.bed")`) 
* `r length(insDf[,1])` insertions (red) [INS](`r paste0("../samples/",sample,"/",sample,"_dellyFiltered/INS.bed")`) 
* `r length(dupDf[,1])` duplications (orange) [DUP](`r paste0("../samples/",sample,"/",sample,"_dellyFiltered/DUP.bed")`) 
* `r length(delDf[,1])` deletions (blue) [DEL](`r paste0("../samples/",sample,"/",sample,"_dellyFiltered/DEL.bed")`) 
* `r length(invDf[,1])` inversions (green) [INV](`r paste0("../samples/",sample,"/",sample,"_dellyFiltered/INV.bed")`) 
