...
invDf <- read.delim(paste0(sample,"_dellyFiltered/INV.bed"),stringsAsFactors=F,header=T,sep="\t")
delDf <- read.delim(paste0(sample,"_dellyFiltered/DEL.bed"),stringsAsFactors=F,header=T,sep="\t")
insDf <- read.delim(paste0(sample,"_dellyFiltered/INS.bed"),stringsAsFactors=F,header=T,sep="\t")
bndDf <- read.delim(paste0(sample,"_dellyFiltered/BND.bed"),stringsAsFactors=F,header=T,sep="\t")
dupDf <- read.delim(paste0(sample,"_dellyFiltered/DUP.bed"),stringsAsFactors=F,header=T,sep="\t")
