...
parser$add_argument("--keepMultipleAlts" , action="store_true" , help="keep positions with multiple alternative variants. WARNING: This option is deprecated. I am not sure whether snpEff report the effect of the firt or the second (or third) alternative. So it is safer to discard multi alts position, as for default [default %(default)s]" , default=FALSE)
